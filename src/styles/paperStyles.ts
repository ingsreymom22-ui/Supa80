...
export const PAPER_STYLES: PaperStyleDefinition[] = [
  ...
  { id: 'dots-orange', name: 'Orange Dot', className: 'paper-dots-orange shadow-xl', previewColor: '#fff7ed' },
  { id: 'dots-sparse-orange', name: 'Sparse Orange Dot', className: 'paper-dots-sparse-orange shadow-xl', previewColor: '#fff7ed' },
  { id: 'dots-emerald', name: 'Emerald Dot', className: 'paper-dots-emerald shadow-xl', previewColor: '#ecfdf5' },
  { id: 'dots-sparse-emerald', name: 'Sparse Emerald Dot', className: 'paper-dots-sparse-emerald shadow-xl', previewColor: '#ecfdf5' },
  { id: 'dots-blue', name: 'Blue Dot', className: 'paper-dots-blue shadow-xl', previewColor: '#eff6ff' },
  { id: 'dots-sparse-blue', name: 'Sparse Blue Dot', className: 'paper-dots-sparse-blue shadow-xl', previewColor: '#eff6ff' },
  { id: 'dots-purple', name: 'Purple Dot', className: 'paper-dots-purple shadow-xl', previewColor: '#faf5ff' },
  { id: 'dots-sparse-purple', name: 'Sparse Purple Dot', className: 'paper-dots-sparse-purple shadow-xl', previewColor: '#faf5ff' },
  { id: 'dots-rose', name: 'Rose Dot', className: 'paper-dots-rose shadow-xl', previewColor: '#fff1f2' },
  { id: 'dots-sparse-rose', name: 'Sparse Rose Dot', className: 'paper-dots-sparse-rose shadow-xl', previewColor: '#fff1f2' },
  { id: 'dots-amber', name: 'Amber Dot', className: 'paper-dots-amber shadow-xl', previewColor: '#fffbeb' },
  { id: 'dots-sparse-amber', name: 'Sparse Amber Dot', className: 'paper-dots-sparse-amber shadow-xl', previewColor: '#fffbeb' },
  { id: 'dots-cyan', name: 'Cyan Dot', className: 'paper-dots-cyan shadow-xl', previewColor: '#ecfeff' },
  { id: 'dots-sparse-cyan', name: 'Sparse Cyan Dot', className: 'paper-dots-sparse-cyan shadow-xl', previewColor: '#ecfeff' },
  { id: 'dots-teal', name: 'Teal Dot', className: 'paper-dots-teal shadow-xl', previewColor: '#f0fdfa' },
  { id: 'dots-sparse-teal', name: 'Sparse Teal Dot', className: 'paper-dots-sparse-teal shadow-xl', previewColor: '#f0fdfa' },
  { id: 'dots-fuchsia', name: 'Fuchsia Dot', className: 'paper-dots-fuchsia shadow-xl', previewColor: '#fdf4ff' },
  { id: 'dots-sparse-fuchsia', name: 'Sparse Fuchsia Dot', className: 'paper-dots-sparse-fuchsia shadow-xl', previewColor: '#fdf4ff' },
  { id: 'dots-lime', name: 'Lime Dot', className: 'paper-dots-lime shadow-xl', previewColor: '#f7fee7' },
  { id: 'dots-sparse-lime', name: 'Sparse Lime Dot', className: 'paper-dots-sparse-lime shadow-xl', previewColor: '#f7fee7' },
